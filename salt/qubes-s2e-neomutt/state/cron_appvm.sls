...
qubes-s2e-neomutt-store_transferred_cold_storage:
  file.managed:
    - name: /home/user/.mutt/scripts/sync_to_cold_storage.sh
    - source: salt://qubes-s2e-neomutt/files/sync_to_cold_storage.sh
    - mode: "0755"
    - user: user
    - group: user
    - makedirs: True
...
qubes-s2e-neomutt-appvm-cold-storage-cron:
  cron.present:
    - name: "/home/user/.mutt/scripts/sync_to_cold_storage.sh > /tmp/CS_last_run.log 2>&1"
    - user: "user"
    - minute: '*/5'
